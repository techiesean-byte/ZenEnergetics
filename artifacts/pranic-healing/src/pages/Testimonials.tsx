        ...
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          >
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="font-serif text-3xl font-light text-foreground leading-none">4.9</span>
                  <div className="flex items-center gap-0.5">
                    {[1,2,3,4,5].map(s => (
                      <Star key={s} size={16} className="text-[#FBBC05] fill-[#FBBC05]" />
                    ))}
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
                  Based on <span className="font-medium text-foreground">127 Google reviews</span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center sm:items-end gap-2 text-center sm:text-right">
              ...
              <a
                href="https://www.google.com/search?q=pranic+healing+rosalyn+piza"
                target="_blank"
